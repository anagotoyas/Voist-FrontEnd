  ...
  return (
    <div className="bg-lightgray w-[13rem] h-[10rem] flex items-center justify-center relative p-6 font-quicksand rounded-lg">
        <div className="flex flex-col items-center">
            ...
            <h3 className="font-semibold pt-1 truncate w-40 text-center">{props.name}</h3>
        </div>
        <div className="absolute right-2 top-2 text-lg p-1 text-red-500 hover:bg-gray-200 rounded-full">
            <RiDeleteBin4Fill/>
        </div>
    </div>
  )
