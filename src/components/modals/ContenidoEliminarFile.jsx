...
export const ContenidoEliminarFile = ({ onClose, id, type}) => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <Button disabled={loading} onClick={onClose} className="p-5 hover:bg-gray-500">
        Cancelar
      </Button>
      <Button disabled={loading} onClick={eliminarFile} className="bg-red-500 hover:bg-gray-500">
        Confirmar
      </Button>
      </div>
    </div>
